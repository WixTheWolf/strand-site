...
export const CAPTAIN_PLAYERS: CaptainPlayer[] = [
  {
    id: "matt-wixted", name: "Matt Wixted", nickname: "WIX", role: "The Playing Captain",
    ...
    prep: ["Build one reliable driver shape and one fairway-finder for pressure holes.", "Practice 30–80 yard wedges and center-green approaches instead of chasing flags.", "Play one match-play round where you announce the match state every three holes and reset immediately after mistakes."],
    formats: { Fourball: "Be the communicator. Keep one score alive, know when your partner is covered, and do not let captain duties pull you out of your own routine.", Shamble: "Choose the ball that creates the easiest next shot, not the most impressive drive. Keep the team moving and decisions simple.", Scramble: "Assign order clearly, secure a ball first, and save your aggressive swing for when the team has protection.", Singles: "Stop captaining for four hours. Play your target, trust your tempo, and make the opponent earn every hole." },
