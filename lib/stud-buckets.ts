...
export const PATH_TO_38 = [
  { format: "fourball", round: "Round 1", label: "Fourball", course: "Gamble Sands", points: 15, target: 8, directive: "Build five dependable floors. One steady ball stays alive while the partner attacks." },
  { format: "shamble", round: "Round 2", label: "Shamble", course: "Scarecrow", points: 15, target: 8, directive: "Pair driving reliability with net leverage. Choose the drive that creates the best angle, not the longest story." },
  { format: "singles", round: "Round 3", label: "Singles", course: "Scarecrow", points: 30, target: 14, directive: "Win the middle of the board. Avoid donating holes and force opponents to earn every point." },
  { format: "scramble", round: "Round 4", label: "2-Man Scramble", course: "Gamble Sands", points: 15, target: 8, directive: "Use complementary pairs: one ball in play, one green-light swing, then putt aggressively from inside the correct line." },
] as const;
